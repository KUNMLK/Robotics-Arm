...
本指南专为0基础学习者打造，全面列举具身智能与机器人操作领域所有常见的机械臂平台，详细说明其核心特点、用途及可直接上手的学习资源（含GitHub链接），助你快速从零开始进入机器人操作的世界。


## 🌟 什么是机器人机械臂？

如果说相机是机器人的“眼睛”，那么机械臂就是机器人的“双手”——它是机器人执行物理操作任务的执行器官。机械臂由关节（自由度）和连杆构成，末端可安装夹爪、灵巧手、吸盘等工具，实现抓取、放置、装配、拧紧、焊接等各种操作任务。在具身智能领域，机械臂是算法学习的“身体”，是机器人与环境交互的直接接口。
